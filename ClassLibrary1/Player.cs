...
namespace Engine
{
    public class Player : LivingCreature
    {
                ...
                base(currentHitPoints, maximumHitPoints)
        {
            ...
            Inventory = new List<InventoryItem>(); //these two lines set teh value of the new properties to EMPTY LISTS
            Quests = new List<PlayerQuest>(); //if we didnt do this, they would be NULL, and you cant add stuff to null values
        }
        ...
        {
            //see if the player has all the items to complete the quest here
        ...
        public void AddItemToInventory(Item itemToAdd)
        {
            foreach(InventoryItem ii in Inventory)
            {
                ...
                {
                    //they have the iteom in their inventory, so increase the quantity by one
                    ii.Quantity++;
