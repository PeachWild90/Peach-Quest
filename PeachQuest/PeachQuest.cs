...
namespace PeachQuest
{
    public partial class PeachQuest : Form
        
    {
        private Player _player;
        private Monster _currentMonster;

        public PeachQuest() //This is the CONSTRUCTOR for the class
        {                   //The code in the constructor gets called when we CREATE A NEW OBJECT OF THE CLASS
                            //In this case, the FORM (the literal white space UI)
                            //This is where we INSTANTIATE a Player object and STORE IT IN THE _player VARIABLE
            InitializeComponent();
            ...
            //This creates a new Player object (right side) and assigns it  to the left side (_player object)
            //Now that we have a Player object, we can start working wtih is, setting its properties and reading them

            lblHitPoints.Text = _player.CurrentHitPoints.ToString();
            lblGold.Text = _player.Gold.ToString();
            lblExperience.Text = _player.ExperiencePoints.ToString();
            lblLevel.Text = _player.Level.ToString(); //In these lines, we are getting the values from the properties the _player
                                                      //object, and assigning them to the text of the the labels on the screen
            //* Note * Since the Text property is a string, and the CurrentHitPoints, Gold, experiencePoints and Level properties
            //are all integers we need to add the ToString() at the end of them. 
        }
        ...
        private void MoveTo(Location newLocation)
        {
            ...
            {
                //calls to the player object
                //see if the player has the quest, and if theyve completed it
                bool playerAlreadyHasQuest = _player.HasThisQuest(newLocation.QuestAvailableHere);
                bool playerAlreadyCompletedQuest = _player.CompletedThisQuest(newLocation.QuestAvailableHere);
                bool playerHasAllItemsToCompleteQuest = _player.HasAllQuestCompletionItems(newLocation.QuestAvailableHere);

                //The player has the required items to complete the quest
                if (playerHasAllItemsToCompleteQuest)
                {
                    //display message
                    rtbMessages.Text += Environment.NewLine;
                    rtbMessages.Text += "You just completed the " +
        ...
        private void btnUseWeapon_Click(object sender, EventArgs e)
        {
            ...
            if(_currentMonster.CurrentHitPoints <= 0)
            {
                ...
                //Move player to current location (to heal player and creata a new monster to fight)
        ...
        private void btnUsePotion_Click(object sender, EventArgs e)
        {
            ...
            //Determine the amount of damage the monster odes to the player
            int damageToPlayer =
